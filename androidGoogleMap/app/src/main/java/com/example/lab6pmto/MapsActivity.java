...
import com.example.lab6pmto.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* requestPermision();*/
        ...
        double[] coordinates = {extras.getDouble("coordinate1"),extras.getDouble("coordinate2")};
        Log.e("Coordinates", String.valueOf(coordinates[0])+String.valueOf(coordinates[1]));
        start = new LatLng(49.23, 23.81);
        end = new LatLng(coordinates[0],coordinates[1]);
